  ...
  <div class="auth-page">
    ...
    <div class="hidden lg:block" aria-hidden="true">
      <div class="auth-float auth-float-1 auth-enter auth-enter-delay-5">
        <span class="auth-score-pill" style="--pill-color: var(--color-score-strong)">7.6</span>
      </div>
      <div class="auth-float auth-float-2 auth-enter auth-enter-delay-6">
        <span class="auth-score-pill" style="--pill-color: var(--color-score-elite)">9.1</span>
      </div>
      <div class="auth-float auth-float-3 auth-enter auth-enter-delay-5">
        <span class="auth-score-pill" style="--pill-color: var(--color-score-adequate)">5.8</span>
      </div>
      <div class="auth-float auth-float-4 auth-enter auth-enter-delay-6">
        <span class="auth-score-pill" style="--pill-color: var(--color-score-strong)">8.4</span>
      </div>
    </div>
...
/* Gradient orbs — shifted positions from SignIn for visual freshness */
.auth-orb {
  position: absolute;
  border-radius: 50%;
  filter: blur(120px);
...
/* Floating score pills — mirrored positions from SignIn */
.auth-float {
  position: fixed;
  z-index: 5;
  pointer-events: none;
